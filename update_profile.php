...
if(isset($_POST['update_profile'])){
   ...
   $update_phone_number = mysqli_real_escape_string($conn, $_POST['phone_number']);
   mysqli_query($conn, "UPDATE `user_form` SET name = '$update_name', email = '$update_email', phone_number='$update_phone_number' WHERE id = '$user_id'") or die('query failed');
...
<div class="update-profile">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <input type="intger" name="old_phone_number" value="<?php echo $fetch['phone_number']; ?>" class="box">
         </div>
         <div class="inputBox">
